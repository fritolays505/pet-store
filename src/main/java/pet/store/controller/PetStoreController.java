...
public class PetStoreController {
	...
	public String handleGetRequest() {
		log.info("GET /pet_store/getinfo hit.");
		return "Pet store endpoint is working...or is it?";
	}
	...
	public PetStoreEmployee addEmployeeToPetStore(@PathVariable Long petStoreId, @RequestBody PetStoreEmployee petStoreEmployee) {
		log.info("Adding employeed {} to pet store ID = {}", petStoreEmployee, petStoreId);
	...
	public Map<String, String> deletePetStoreById(@PathVariable Long petStoreId){
		...
		return Map.of("message", "Pet store ID =" + petStoreId + " deleted.");
	}
